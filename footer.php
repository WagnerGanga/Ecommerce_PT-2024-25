        ...
        <div class="row" style="padding-bottom: 40px;">
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.php"> <span>AngoShop.</span>
                        </a>
                    </div>
                    <ul>
                        <li>+244 940822206</li>
                        <li>AngoShop@gmail.com</li>
                        <li>Angola.Luanda:Kapolo2</li>
                    </ul>
            ...
            <div class="col-lg-4">
                <div class="newslatter-item">
                    ...
                    <p>Obtenha atualizações por e -mail sobre nossas últimas ofertas especiais.</p>
