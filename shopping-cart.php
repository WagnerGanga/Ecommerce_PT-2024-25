                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="cart-buttons">
                            ...
                            <a href="shop.php" class="primary-btn continue-shop">Continue fazendo compras</a>
                            <a href="shopping-cart.php?upd=" class="primary-btn up-cart">Atualização do Carrinho</a>
                        </div>
                    ...
                    <div class="col-lg-4 offset-lg-4">
                        <div class="proceed-checkout">
                            ...
                            <a href="check-out.php" class="proceed-btn">FAZER O CHECK-OUT</a>
                        </div>
                    </div>
                </div>
            </div>
