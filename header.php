                    ...
                    <div class="col-md-6">
                        <form method="post">
                            <div class="input-group">
                                <input type="text" name="search" placeholder="Pesquise ou Compre" required>
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                    ...
                                    <div class="select-button">
                                        <a href="shopping-cart.php" class="primary-btn view-card">Veja todos os itens</a>
                                        <a href="check-out.php" class="primary-btn checkout-btn">CONFIRA</a>
                                    </div>
                                </div>
                            </li>
        ...
        <div class="nav-item">
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        <li class="<?php if ($active == 'Home') echo "active" ?>"><a href="index.php">Início</a></li>
                        <li class="<?php if ($active == 'Shop') echo "active" ?>"><a href="shop.php">Loja</a></li>
                        <li class="<?php if ($active == 'Contact') echo "active" ?>"><a href="contact.php">Contato</a></li>
